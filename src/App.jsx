...
// ── PHOTO GALLERY DATA ─────────────────────────────────────────────
const PHOTOS = [
  {id:0, src:"https://images.unsplash.com/photo-1551867633-194f125bddfa?w=600&q=80", alt:"Italian hilltop village", captionIt:"Borgo Collinare Irpino", captionEn:"Irpinian Hilltop Village", descIt:"Paesaggio tipico dell'Irpinia: borghi arroccati sulle colline della Valle del Sabato.", descEn:"Typical Irpinian landscape: villages perched on the hills of the Sabato Valley."},
  {id:1, src:"https://images.unsplash.com/photo-1583425921686-c5daf5f49e4a?w=600&q=80", alt:"Italian church", captionIt:"Chiesa Campana", captionEn:"Campanian Church", descIt:"L'architettura sacra della Campania, come la Chiesa di Maria SS. Addolorata a Pratola Serra.", descEn:"Sacred architecture of Campania, like the Church of Maria SS. Addolorata in Pratola Serra."},
  {id:2, src:"https://images.unsplash.com/photo-1596796737300-ddf7da824739?w=600&q=80", alt:"Medieval ruins", captionIt:"Rovine Medievali", captionEn:"Medieval Ruins", descIt:"Come i ruderi del castello di Serra di Pratola, che domina la valle dall'alto della collina.", descEn:"Like the castle ruins of Serra di Pratola, overlooking the valley from the hilltop."},
  {id:3, src:"https://images.unsplash.com/photo-1565799943281-3e2a1b26e680?w=600&q=80", alt:"Ellis Island immigration", captionIt:"L'Emigrazione in America", captionEn:"Emigration to America", descIt:"Milioni di italiani attraversarono l'oceano, incluse le famiglie Altavilla e Pisano di Pratola Serra.", descEn:"Millions of Italians crossed the ocean, including the Altavilla and Pisano families from Pratola Serra."},
  {id:4, src:"https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&q=80", alt:"Italian vineyard hills", captionIt:"Le Colline del Taurasi", captionEn:"The Taurasi Hills", descIt:"Le colline irpine che producono il Taurasi DOCG, il 'Barolo del Sud'.", descEn:"The Irpinian hills that produce Taurasi DOCG, the 'Barolo of the South'."},
  {id:5, src:"https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&q=80", alt:"Italian food", captionIt:"I Sapori di Casa", captionEn:"Tastes of Home", descIt:"Caciocavallo, soppressata, cavatielli — i sapori che i Pratolani portano nel mondo.", descEn:"Caciocavallo, soppressata, cavatielli — the flavors Pratolani carry around the world."},
];
